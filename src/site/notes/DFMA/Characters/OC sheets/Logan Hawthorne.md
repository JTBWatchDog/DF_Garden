...
>> These nexus points can be connected in series, with a range of 30m between points, allowing Logan to create a series of reinforced buildings. This **Nexal Reinforcement Series** gets slightly stronger with each added nexus point. If he wants to remain combat ready, he can only make one of these a day. 
