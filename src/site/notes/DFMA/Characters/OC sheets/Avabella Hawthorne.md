...
#### ¶ Description
Avabella Hawthorne is regarded as the current master, or the only living person close to being considered such, of the Hawthorne wyrgcræft (literally "cursed skill", though it is also translated as "hidden skill",) Arcana Augere. 
...
This pressure gets generated by the heart every turn according to the "Gear" it is in. Avabella has four of these, listed here. She can change Gear once every turn.
...
>> Based off of **Enhancement**, Ava's aura increases in size and intensity, and now passively extends 1m from her body. Her aura control grows considerably; mana efficiency rises further. The range in which she can control the aura is now 3m; its power in cqc skyrockets. She can now use it to extend the reach of her hits and shape it into additional limbs, for multiple purposes.
>
